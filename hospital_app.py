...
# Load Model
def load_model():
    with open('hospital_model_Akhtar.pkl', 'rb') as f:
...
DEPT_INFO = {
    'Respiratory Medicine' : {
        ...
        'bg':'#E0F2FE',
        'border':'#7DD3FC',
        'desc':'Specialises in condition affecting the heart and cardiovascular conditions.',
...
if submitted:
    ...
    st.markdown(
        ...
        <div>
            ...
            <h4>Why</h4>
            <p>{info['desc']}. Your reported system and vitals match patients typically directed to this department.</p>
            ...
            <p>⚠️ WARNING: This is an AI suggestion, not a medical diagnosis. Please consult to a doctor for further evaluation.</p>
        </div>
        """, unsafe_allow_html=True
    )
